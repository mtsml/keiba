...
class Db:
    ...
    def insert_horse(self, horse_info):
        ...
        with self.get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute("INSERT INTO horse(horse_id, horse_name, birthday, trainer_id, owner_id, breeder_id, birthplace, selling_price, father_horse_id, mother_horse_id) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT (horse_id) DO NOTHING",
